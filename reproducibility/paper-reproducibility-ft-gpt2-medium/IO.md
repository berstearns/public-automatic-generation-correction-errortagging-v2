...
Model: **ft-gpt2-medium** (355M)
- rclone source: `i:/<your-rclone-models>/gpt2/gpt2-medium-all-data/best/checkpoint-5625`
- Local path: `./models/gpt2/gpt2-medium-all-data/best/checkpoint-5625`
...
**Input:** rclone remote `i:/<your-rclone-models>/gpt2/gpt2-medium-all-data/best/checkpoint-5625`
**Output:** `./models/gpt2/gpt2-medium-all-data/best/checkpoint-5625/` containing HuggingFace model files

**Command:**
```bash
rclone copy "i:/<your-rclone-models>/gpt2/gpt2-medium-all-data/best/checkpoint-5625" "./models/gpt2/gpt2-medium-all-data/best/checkpoint-5625" --progress
```
...
- `ft-gpt2-medium_summary.json` — Per-model metrics
...
```
reproducibility/paper-reproducibility-ft-gpt2-medium/
├── plan/
│   ├── overview.md
│   └── steps.md
├── scripts/
