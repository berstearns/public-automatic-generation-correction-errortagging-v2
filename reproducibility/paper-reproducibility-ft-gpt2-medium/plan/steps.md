...
- Check if `./models/gpt2/gpt2-medium-all-data/best/checkpoint-5625` exists locally
- If not: download from `i:/<your-rclone-models>/gpt2/gpt2-medium-all-data/best/checkpoint-5625` via rclone
