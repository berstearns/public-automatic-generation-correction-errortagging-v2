...
```bash
rclone copy "i:/<your-rclone-models>/gpt2/gpt2-medium-all-data/best/checkpoint-5625" \
    "./models/gpt2/gpt2-medium-all-data/best/checkpoint-5625" \
    --progress
```

Verify:
```bash
ls ./models/gpt2/gpt2-medium-all-data/best/checkpoint-5625/config.json
```

## One-command run (recommended)

```bash
.venv/bin/python reproducibility/paper-reproducibility-ft-gpt2-medium/scripts/run_experiment.py
```
...
.venv/bin/python -m gen_gec_errant.pipeline \
    --config reproducibility/paper-reproducibility-ft-gpt2-medium/experiment/configs/norm-CELVA-SP.yaml
```
