#!/usr/bin/env python3
"""
End-to-end GPT-2 Medium (355M) fine-tuned on EFCAMDAT all-data Error Profile Experiment.

Runs the full generate -> GEC -> ERRANT -> analysis pipeline using
ft-gpt2-medium (fine-tuned on EFCAMDAT all-data) on multiple learner datasets.
...
# -- Model -----------------------------------------------------------------
MODEL_NAME = "ft-gpt2-medium"
HF_MODEL_ID = "./models/gpt2/gpt2-medium-all-data/best/checkpoint-5625"
BASE_HF_ID = "gpt2-medium"
MODEL_FAMILY = "gpt2"
MODEL_PARAMS = "355M"
RCLONE_DIR = "i:/<your-rclone-models>/gpt2/gpt2-medium-all-data"
LOCAL_DIR = Path("./models/gpt2/gpt2-medium-all-data")
