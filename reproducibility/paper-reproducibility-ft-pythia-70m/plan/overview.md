# Pythia 70M fine-tuned on EFCAMDAT all-data — Error Profile Experiment

## Goal

Run the full generate-GEC-ERRANT-analysis pipeline using **ft-pythia-70m**
(Pythia 70M fine-tuned on EFCAMDAT all-data) on learner corpus data.
This model is a **fine-tuned artificial learner**: pre-trained EleutherAI/pythia-70m
...
3. Generate continuations with ft-pythia-70m (fine-tuned on EFCAMDAT)
...
- **ft-pythia-70m** (70M parameters)
- Base: `EleutherAI/pythia-70m` (pre-trained)
- Fine-tuned on: EFCAMDAT all-data (full learner corpus, all CEFR levels)
- Architecture family: pythia
- rclone source: `i:/<your-rclone-models>/pythia/pythia-70m-all-data`
