#!/usr/bin/env python3
"""
End-to-end SmolLM2 360M fine-tuned on EFCAMDAT all-data Error Profile Experiment.

Runs the full generate -> GEC -> ERRANT -> analysis pipeline using
ft-smollm2-360m (fine-tuned on EFCAMDAT all-data) on multiple learner datasets.
...
# -- Model -----------------------------------------------------------------
MODEL_NAME = "ft-smollm2-360m"
HF_MODEL_ID = "./models/smollm2/smollm2-360m-all-data/final"
BASE_HF_ID = "HuggingFaceTB/SmolLM2-360M"
MODEL_FAMILY = "smollm2"
MODEL_PARAMS = "360M"
RCLONE_DIR = "i:/<your-rclone-models>/smollm2/smollm2-360m-all-data"
LOCAL_DIR = Path("./models/smollm2/smollm2-360m-all-data")
