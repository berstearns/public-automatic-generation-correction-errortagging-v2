...
Model: **ft-smollm2-360m** (360M)
- rclone source: `i:/<your-rclone-models>/smollm2/smollm2-360m-all-data/final`
...
**Input:** rclone remote `i:/<your-rclone-models>/smollm2/smollm2-360m-all-data/final`
**Output:** `./models/smollm2/smollm2-360m-all-data/final/` containing HuggingFace model files

**Command:**
```bash
rclone copy "i:/<your-rclone-models>/smollm2/smollm2-360m-all-data/final" "./models/smollm2/smollm2-360m-all-data/final" --progress
```
...
- `ft-smollm2-360m_summary.json` — Per-model metrics
...
```
reproducibility/paper-reproducibility-ft-smollm2-360m/
├── plan/
│   ├── overview.md
│   └── steps.md
├── scripts/
