...
Model: **ft-pythia-160m** (160M)
- rclone source: `i:/<your-rclone-models>/pythia/pythia-160m-all-data/final`
- Local path: `./models/pythia/pythia-160m-all-data/final`
...
**Input:** rclone remote `i:/<your-rclone-models>/pythia/pythia-160m-all-data/final`
**Output:** `./models/pythia/pythia-160m-all-data/final/` containing HuggingFace model files

**Command:**
```bash
rclone copy "i:/<your-rclone-models>/pythia/pythia-160m-all-data/final" "./models/pythia/pythia-160m-all-data/final" --progress
```
...
- `ft-pythia-160m_summary.json` — Per-model metrics
...
```
reproducibility/paper-reproducibility-ft-pythia-160m/
├── plan/
│   ├── overview.md
│   └── steps.md
├── scripts/
