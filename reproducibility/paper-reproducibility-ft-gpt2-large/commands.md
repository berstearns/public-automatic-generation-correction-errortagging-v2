...
```bash
rclone copy "i:/<your-rclone-models>/gpt2/gpt2-large-all-data/best/checkpoint-6750" \
    "./models/gpt2/gpt2-large-all-data/best/checkpoint-6750" \
    --progress
```

Verify:
```bash
ls ./models/gpt2/gpt2-large-all-data/best/checkpoint-6750/config.json
```
