...
- Check if `./models/gpt2/gpt2-large-all-data/best/checkpoint-6750` exists locally
- If not: download from `i:/<your-rclone-models>/gpt2/gpt2-large-all-data/best/checkpoint-6750` via rclone
