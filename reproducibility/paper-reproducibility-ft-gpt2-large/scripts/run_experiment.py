#!/usr/bin/env python3
"""
End-to-end GPT-2 Large (774M) fine-tuned on EFCAMDAT all-data Error Profile Experiment.

Runs the full generate -> GEC -> ERRANT -> analysis pipeline using
ft-gpt2-large (fine-tuned on EFCAMDAT all-data) on multiple learner datasets.
...
# -- Model -----------------------------------------------------------------
MODEL_NAME = "ft-gpt2-large"
HF_MODEL_ID = "./models/gpt2/gpt2-large-all-data/best/checkpoint-6750"
BASE_HF_ID = "gpt2-large"
MODEL_FAMILY = "gpt2"
MODEL_PARAMS = "774M"
RCLONE_DIR = "i:/<your-rclone-models>/gpt2/gpt2-large-all-data"
LOCAL_DIR = Path("./models/gpt2/gpt2-large-all-data")
