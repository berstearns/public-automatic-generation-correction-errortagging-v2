...
Model: **ft-pythia-1.4b** (1.4B)
- rclone source: `i:/<your-rclone-models>/pythia/pythia-1.4b-all-data/final`
...
**Input:** rclone remote `i:/<your-rclone-models>/pythia/pythia-1.4b-all-data/final`
**Output:** `./models/pythia/pythia-1.4b-all-data/final/` containing HuggingFace model files

**Command:**
```bash
rclone copy "i:/<your-rclone-models>/pythia/pythia-1.4b-all-data/final" "./models/pythia/pythia-1.4b-all-data/final" --progress
```
...
- `ft-pythia-1.4b_summary.json` — Per-model metrics
...
```
reproducibility/paper-reproducibility-ft-pythia-1.4b/
├── plan/
│   ├── overview.md
│   └── steps.md
├── scripts/
