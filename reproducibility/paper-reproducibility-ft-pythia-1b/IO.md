...
Model: **ft-pythia-1b** (1B)
- rclone source: `i:/<your-rclone-models>/pythia/pythia-1b-all-data/final`
- Local path: `./models/pythia/pythia-1b-all-data/final`
...
**Input:** rclone remote `i:/<your-rclone-models>/pythia/pythia-1b-all-data/final`
**Output:** `./models/pythia/pythia-1b-all-data/final/` containing HuggingFace model files

**Command:**
```bash
rclone copy "i:/<your-rclone-models>/pythia/pythia-1b-all-data/final" "./models/pythia/pythia-1b-all-data/final" --progress
```
...
- `ft-pythia-1b_summary.json` — Per-model metrics
...
```
reproducibility/paper-reproducibility-ft-pythia-1b/
├── plan/
│   ├── overview.md
│   └── steps.md
├── scripts/
