#!/usr/bin/env python3
"""
End-to-end Pythia 1B fine-tuned on EFCAMDAT all-data Error Profile Experiment.

Runs the full generate -> GEC -> ERRANT -> analysis pipeline using
ft-pythia-1b (fine-tuned on EFCAMDAT all-data) on multiple learner datasets.
...
# -- Model -----------------------------------------------------------------
MODEL_NAME = "ft-pythia-1b"
HF_MODEL_ID = "./models/pythia/pythia-1b-all-data/final"
BASE_HF_ID = "EleutherAI/pythia-1b"
MODEL_FAMILY = "pythia"
MODEL_PARAMS = "1B"
RCLONE_DIR = "i:/<your-rclone-models>/pythia/pythia-1b-all-data"
LOCAL_DIR = Path("./models/pythia/pythia-1b-all-data")
