...
- Check if `./models/smollm2/smollm2-135m-all-data/final` exists locally
- If not: download from `i:/<your-rclone-models>/smollm2/smollm2-135m-all-data/final` via rclone
...
- For each dataset (CELVA-SP, EFCAMDAT-test, KUPA-KEYS):
  ...
  - Generate continuations with ft-smollm2-135m from local checkpoint
