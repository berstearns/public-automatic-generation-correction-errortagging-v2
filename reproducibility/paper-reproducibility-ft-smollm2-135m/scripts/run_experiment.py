#!/usr/bin/env python3
"""
End-to-end SmolLM2 135M fine-tuned on EFCAMDAT all-data Error Profile Experiment.

Runs the full generate -> GEC -> ERRANT -> analysis pipeline using
ft-smollm2-135m (fine-tuned on EFCAMDAT all-data) on multiple learner datasets.
...
# -- Model -----------------------------------------------------------------
MODEL_NAME = "ft-smollm2-135m"
HF_MODEL_ID = "./models/smollm2/smollm2-135m-all-data/final"
BASE_HF_ID = "HuggingFaceTB/SmolLM2-135M"
MODEL_FAMILY = "smollm2"
MODEL_PARAMS = "135M"
RCLONE_DIR = "i:/<your-rclone-models>/smollm2/smollm2-135m-all-data"
LOCAL_DIR = Path("./models/smollm2/smollm2-135m-all-data")
