...
Model: **ft-smollm2-1.7b** (1.7B)
- rclone source: `i:/<your-rclone-models>/smollm2/smollm2-1.7b-all-data/final`
- Local path: `./models/smollm2/smollm2-1.7b-all-data/final`
...
**Input:** rclone remote `i:/<your-rclone-models>/smollm2/smollm2-1.7b-all-data/final`
**Output:** `./models/smollm2/smollm2-1.7b-all-data/final/` containing HuggingFace model files

**Command:**
```bash
rclone copy "i:/<your-rclone-models>/smollm2/smollm2-1.7b-all-data/final" "./models/smollm2/smollm2-1.7b-all-data/final" --progress
```
...
- `ft-smollm2-1.7b_summary.json` — Per-model metrics
...
```
reproducibility/paper-reproducibility-ft-smollm2-1.7b/
├── plan/
│   ├── overview.md
│   └── steps.md
├── scripts/
