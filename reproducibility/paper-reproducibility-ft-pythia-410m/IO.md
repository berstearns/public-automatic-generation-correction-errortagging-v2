...
Model: **ft-pythia-410m** (410M)
- rclone source: `i:/<your-rclone-models>/pythia/pythia-410m-all-data/final`
- Local path: `./models/pythia/pythia-410m-all-data/final`
...
**Input:** rclone remote `i:/<your-rclone-models>/pythia/pythia-410m-all-data/final`
**Output:** `./models/pythia/pythia-410m-all-data/final/` containing HuggingFace model files

**Command:**
```bash
rclone copy "i:/<your-rclone-models>/pythia/pythia-410m-all-data/final" "./models/pythia/pythia-410m-all-data/final" --progress
```
...
- `ft-pythia-410m_summary.json` — Per-model metrics
...
```
reproducibility/paper-reproducibility-ft-pythia-410m/
├── plan/
│   ├── overview.md
│   └── steps.md
├── scripts/
