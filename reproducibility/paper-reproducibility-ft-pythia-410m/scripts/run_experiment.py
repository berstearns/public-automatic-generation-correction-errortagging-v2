#!/usr/bin/env python3
"""
End-to-end Pythia 410M fine-tuned on EFCAMDAT all-data Error Profile Experiment.

Runs the full generate -> GEC -> ERRANT -> analysis pipeline using
ft-pythia-410m (fine-tuned on EFCAMDAT all-data) on multiple learner datasets.
...
# -- Model -----------------------------------------------------------------
MODEL_NAME = "ft-pythia-410m"
HF_MODEL_ID = "./models/pythia/pythia-410m-all-data/final"
BASE_HF_ID = "EleutherAI/pythia-410m"
MODEL_FAMILY = "pythia"
MODEL_PARAMS = "410M"
RCLONE_DIR = "i:/<your-rclone-models>/pythia/pythia-410m-all-data"
LOCAL_DIR = Path("./models/pythia/pythia-410m-all-data")
