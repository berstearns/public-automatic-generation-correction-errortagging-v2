#!/usr/bin/env python3
"""
End-to-end GPT-2 Small (124M) fine-tuned on EFCAMDAT all-data Error Profile Experiment.

Runs the full generate -> GEC -> ERRANT -> analysis pipeline using
ft-gpt2-small (fine-tuned on EFCAMDAT all-data) on multiple learner datasets.
...
# -- Model -----------------------------------------------------------------
MODEL_NAME = "ft-gpt2-small"
HF_MODEL_ID = "./models/gpt2/gpt2-small-all-data/best/checkpoint-7596"
BASE_HF_ID = "gpt2"
MODEL_FAMILY = "gpt2"
MODEL_PARAMS = "124M"
RCLONE_DIR = "i:/<your-rclone-models>/gpt2/gpt2-small-all-data"
LOCAL_DIR = Path("./models/gpt2/gpt2-small-all-data")
