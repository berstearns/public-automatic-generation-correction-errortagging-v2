...
```bash
rclone copy "i:/<your-rclone-models>/gpt2/gpt2-small-all-data/best/checkpoint-7596" \
    "./models/gpt2/gpt2-small-all-data/best/checkpoint-7596" \
    --progress
```

Verify:
```bash
ls ./models/gpt2/gpt2-small-all-data/best/checkpoint-7596/config.json
```

## One-command run (recommended)

```bash
.venv/bin/python reproducibility/paper-reproducibility-ft-gpt2-small/scripts/run_experiment.py
```
...
.venv/bin/python -m gen_gec_errant.pipeline \
    --config reproducibility/paper-reproducibility-ft-gpt2-small/experiment/configs/norm-CELVA-SP.yaml
```
