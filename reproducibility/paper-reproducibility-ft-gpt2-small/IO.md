...
Model: **ft-gpt2-small** (124M)
- rclone source: `i:/<your-rclone-models>/gpt2/gpt2-small-all-data/best/checkpoint-7596`
...
**Input:** rclone remote `i:/<your-rclone-models>/gpt2/gpt2-small-all-data/best/checkpoint-7596`
**Output:** `./models/gpt2/gpt2-small-all-data/best/checkpoint-7596/` containing HuggingFace model files

**Command:**
```bash
rclone copy "i:/<your-rclone-models>/gpt2/gpt2-small-all-data/best/checkpoint-7596" "./models/gpt2/gpt2-small-all-data/best/checkpoint-7596" --progress
```
...
- `ft-gpt2-small_summary.json` — Per-model metrics
...
```
reproducibility/paper-reproducibility-ft-gpt2-small/
├── plan/
│   ├── overview.md
│   └── steps.md
├── scripts/
