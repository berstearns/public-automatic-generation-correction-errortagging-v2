...
- Check if `./models/gpt2/gpt2-small-all-data/best/checkpoint-7596` exists locally
- If not: download from `i:/<your-rclone-models>/gpt2/gpt2-small-all-data/best/checkpoint-7596` via rclone
...
- For each dataset (CELVA-SP, EFCAMDAT-test, KUPA-KEYS):
  ...
  - Generate continuations with ft-gpt2-small from local checkpoint
